...
function fncGetProductList(){
	document.detailForm.action='/listProduct.do?menu=${param.menu}';
	...
	<tr>			
		<td align="right">
			...
			<input type="text" name="searchKeyword"  class="ct_input_g" style="width:200px; height:19px"
						...
						class="ct_input_g" style="width:200px; height:20px" onkeypress="if(event.keyCode==13) {javascript:fncGetProductList('1');}"> 
			</td>
